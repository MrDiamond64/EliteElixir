...
module.exports.main = (realmData) => {
    ...
    console.log(`Realm IP: ${realmData.ip} Realm Port: ${realmData.port}`);
    ...
    if (opAll) {
        ...
        client.on("player_list", (packet) => {
            ...
            console.log("Got player list, Giving OP...");
        ...
        client.on("update_abilities", (packet) => {
            ...
            console.log("Got Entity Unique ID. Giving OP...");
...
function splitScreenJoin(client, realmData) {
    ...
    const identity = JWT.sign(payload, privateKey, {
        algorithm: algorithm,
        noTimestamp: true,
        notBefore: 0,
        expiresIn: 60 * 60,
    ...
    const identityChain = JSON.stringify({
        chain
    });
